...
VALUES (1, 'architektur', 'architecture', 'A', 'Architektur', 'Architecture', '0013'),
       ...
       (27, 'eventmanagement-technik-losverfahren', 'event-management-technology-lottery', 'EML', 'Eventmanagement und -technik Losverfahren', 'Event Management and Technology Lottery', '0c71'),
       (28, 'elektrische-energietechnik-regenerative-energiesysteme', 'electrical-energy-technology-renewable-energy-systems', 'ERE', 'Elektrische Energietechnik für regenerative Energiesysteme', 'Electrical Energy Technology for Renewable Energy Systems', '0c70'),
       (29, 'energiesystemtechnik', 'energy-systems-engineering', 'EST', 'Energiesystemtechnik', 'Energy Systems Engineering', '0786'),
       (30, 'allgemeine-elektrotechnik', 'general-electrical-engineering', 'ET', 'Allgemeine Elektrotechnik', 'General Electrical Engineering', '0048'),
       (31, 'facility-management', 'facility-management', 'FM', 'Facility Management', 'Facility Management', '0464'),
       (32, 'future-skills-innovation', 'future-skills-innovation', 'FSI', 'Future Skills und Innovation', 'Future Skills und Innovation', '0g18'),
       (33, 'hebammenwissenschaft', 'midwifery-science', 'HW', 'Hebammenwissenschaft', 'Midwifery Science', '0g59'),
       (34, 'informatik', 'information-science', 'I', 'Informatik', 'Information Science', '0079'),
       (35, 'insektenbiotechnologie-bioressourcen', 'insect-biotechnology-bioresources', 'IBB', 'Insektenbiotechnologie und Bioressourcen', 'Insect Biotechnology and Bioresources', '0e50'),
       (36, 'information-communications-engineering', 'information-communications-engineering', 'ICE', 'Information and Communications Engineering', 'Information and Communications Engineering', '0721'),
       (37, 'immobilien-facility-management', 'real-estate-facility-management', 'IFM', 'Immobilien- und Facility Management', 'Real Estate and Facility Management', '0h92'),
       (38, 'innovationsmanagement', 'innovation-management', 'IM', 'Innovationsmanagement', 'Innovation Management', '0c73'),
       (39, 'ingenieur-informatik', 'informatics-engineers', 'INI', 'Ingenieur-Informatik', 'Informatics for Engineers', '0123'),
       (40, 'international-marketing', 'International-marketing', 'INM', 'International Marketing', 'International Marketing', '0d41'),
       (41, 'infrastrukturmanagement', 'infrastructure-management', 'ISM', 'Infrastrukturmanagement', 'Infrastructure Management', '0883'),
       (42, 'ingenieurwesen', 'engineering', 'IW', 'Ingenieurwesen', 'Engineering', '0286'),
       (43, 'ingenieurwesen-elektrotechnik', 'engineering-electrical-engineering', 'IWE', 'Ingenieurwesen Elektrotechnik', 'Engineering - Electrical Engineering', '0d39'),
       (44, 'wirtschaftsingenieurwesen-immobilien', 'business-administration-real-estate-engineering', 'IWI', 'Wirtschaftsingenieurwesen - Immobilien', 'Business Administration and Real Estate Engineering', '0c75'),
       (45, 'ingenieurwesen-maschinenbau', 'engineering-mechanical-engineering', 'IWM', 'Ingenieurwesen Maschinenbau', 'Engineering - Mechanical Engineering', '0d40'),
       (46, 'wirtschaftsingenieurwesen-industrie', 'industrial-business-administration', 'IWU', 'Wirtschaftsingenieurwesen - Industrie', 'Industrial Business Administration', '0c76'),
       (47, 'infrastruktur-wasser-verkehr', 'water-transport-infrastructure ', 'IWV', 'Infrastruktur - Wasser und Verkehr', 'Water and Transport Infrastructure ', '0f40'),
       (48, 'krankenhaushygiene', 'hospital-hygiene', 'KH', 'Krankenhaushygiene', 'Hospital Hygiene', '0b11'),
       (49, 'krankenhaus-planung-technik', 'hospital-planning-technology', 'KPT', 'Krankenhaus Planung Technik', 'Hospital Planning and Technology', '0c17'),
       (50, 'krankenhaus-technik-management', 'hospital-technology-management', 'KTM', 'Krankenhaus Technik Management', 'Hospital Technology and Management', '0804'),
       (51, 'klimaschutz-umwelt-sicherheitsingenieurwesen', 'climate-protection-environmental-safety-engineering', 'KUS', 'Klimaschutz, Umwelt- und Sicherheitsingenieurwesen', 'Climate Protection, Environmental and Safety Engineering', '0a73'),
       (52, 'logistik', 'logistics', 'LO', 'Logistik', 'Logistics', '0929'),
       (53, 'logistikmanagement', 'logistics-management', 'LOM', 'Logistikmanagement', 'Logistics Management', '0a70'),
       (54, 'life-science-engineering', 'life-science-engineering', 'LSE', 'Life Science Engineering', 'Life Science Engineering', '0yyy'),
       (55, 'maschinenbau', 'mechanical-engineering', 'M', 'Maschinenbau', 'Mechanical Engineering', '0104'),
       (56, 'management-medizin', 'management-medicine', 'MAM', 'Management in der Medizin', 'Management in Medicine', '0f47'),
       (57, 'methoden-didaktik-angewandten-wissenschaften-higher-education', 'methods-didactics-applied-sciences-higher-education', 'MDH', 'Methoden und Didaktik in angewandten Wissenschaften_Higher Education', 'Methods and Didactics in Applied Sciences_Higher Education', '0e15'),
       (58, 'maschinenbau-energiesysteme', 'mechanical-engineering-energy-systems', 'ME', 'Maschinenbau und Energiesysteme', 'Mechanical Engineering and Energy Systems', '0b13'),
       (59, 'mikroelektronik-elektronikdesign', 'microelectronics-electronic-design', 'MeD', 'Mikroelektronik/Elektronikdesign', 'Microelectronics/Electronic Design', '0157'),
       (60, 'mechatronik', 'mechatronics', 'MET', 'Mechatronik', 'Mechatronics', '0380'),
       (61, 'material-fertigungstechnologie', 'materials-manufacturing-technology', 'MF', 'Material- und Fertigungstechnologie', 'Materials and Manufacturing Technology', '0d13'),
       (62, 'mathematik-finanzen-versicherungen-management', 'mathematics-finance-insurance-management', 'MFF', 'Mathematik für Finanzen, Versicherungen und Management', 'Mathematics for Finance, Insurance and Management', '0105'),
       (63, 'medizinische-informatik', 'medical-informatics', 'MIF', 'Medizinische Informatik', 'Medical Informatics', '0247'),
       (64, 'medieninformatik', 'media-informatics', 'MIN', 'Medieninformatik', 'media-informatics', '0121'),
       (65, 'mathematik', 'mathematics', 'MK', 'Mathematik', 'Mathematics', '0105'),
       (66, 'maschinenbau-mechatronik', 'mechanical-engineering-mechatronics', 'MM', 'Maschinenbau Mechatronik', 'Mechanical Engineering and Mechatronics', '0b09'),
       (67, 'medizinisches-management', 'medical-management', 'MMT', 'Medizinisches Management', 'Medical Management', '0d12'),
       (68, 'mathematik-nachhaltigkeit-wirtschaft-data-science', 'mathematics-sustainability-economics-data-science', 'MNW', 'Mathematik für Nachhaltigkeit, Wirtschaft und Data Science', 'Mathematics for Sustainability, Economics and Data Science', '0h91'),
       (69, 'medizinische-physik', 'medical-physics', 'MPH', 'Medizinische Physik', 'Medical Physics', '0691'),
       (70, 'medizinische-physik-strahlenschutz', 'medical-physics-radiation-protection', 'MPS', 'Medizinische Physik und Strahlenschutz', 'Medical Physics and Radiation Protection', '0c72'),
       (71, 'medizintechnik', 'medical-technology', 'MT', 'Medizintechnik', 'Medical Technology', '0805'),
       (72, 'nachrichtentechnik-computernetze', 'communications-engineering-computer-networks', 'NAC', 'Nachrichtentechnik und Computernetze', 'Communications Engineering and Computer Networks', '0c63'),
       (73, 'betriebswirtschaft-nachhaltigkeitsmanagement', 'business-administration-sustainability-management', 'NM', 'Betriebswirtschaft - Nachhaltigkeitsmanagement', 'Business Administration - Sustainability Management', 'h14'),
       (74, 'optotechnik-bildverarbeitung', 'optotechnology-image-processing', 'OBV', 'Optotechnik und Bildverarbeitung', 'Optotechnology and Image Processing', '0999'),
       (75, 'organisations-it-sicherheit', 'organizational-it-security', 'OIT', 'Organisations- und IT-Sicherheit', 'Organizational and IT-Security', '0h94'),
       (76, 'organisationsmanagement-medizin', 'organizational-management-medicine', 'OMM', 'Organisationsmanagement in der Medizin', 'Organizational Management in Medicine', '0b12'),
       (77, 'optical-system-engineering', 'optical-system-engineering', 'OSE', 'Optical System Engineering', 'Optical System Engineering', '0g70'),
       (78, 'orthopaedie-rehatechnik', 'orthopedic-rehabilitation-technology', 'OT', 'Orthopädie- und Rehatechnik', 'Orthopedic and Rehabilitation Technology', '0928'),
       (79, 'public-health', 'public-health', 'PH', 'Public Health', 'Public Health', '0748'),
       (80, 'physikalische-technik', 'physical-engineering', 'PHY', 'Physikalische Technik', 'Physical Engineering', '0224'),
       (81, 'prozessmanagement', 'process-management', 'PM', 'Prozessmanagement', 'Process Management', '0881'),
       (82, 'personalmanagement', 'human-resources', 'PMG', 'Personalmanagement', 'Human Resources', '0d75'),
       (83, 'physik-technologie-raumfahrtanwendungen', 'physics-technology-space-applications', 'PTR', 'Physik und Technologie für Raumfahrtanwendungen', 'Physics and Technology for Space Applications', '0e49'),
       (84, 'supply-chain-management', 'supply-chain-management', 'SCM', 'Supply Chain Management', 'Supply Chain Management', '0689'),
       (85, 'systems-engineering', 'systems-engineering', 'SE', 'Systems Engineering', 'Systems Engineering', '0a68'),
       (86, 'sustainability-transformation-engineering-management', 'sustainability-transformation-engineering-management', 'SEM', 'Sustainability Transformation in Engineering and Management', 'Sustainability Transformation in Engineering and Management', '0h93'),
       (87, 'kooperation-giessen-marburg', 'cooperation-giessen-marburg', 'SKO', 'Kooperation Gießen/Marburg', 'Cooperation Giessen/Marburg', '0xxx'),
       (88, 'strategische-live-kommunikation', 'strategic-live-communication', 'SLK', 'Strategische Live Kommunikation', 'Strategic Live Communication', '0f37'),
       (89, 'strahlenschutz-messtechnik', 'radiation-protection-measurement-technology', 'SM', 'Strahlenschutz- und -messtechnik', 'Radiation Protection and Measurement Technology', '0926'),
       (90, 'social-media-systems', 'social-media-systems', 'SMS', 'Social Media Systems', 'Social Media Systems', '0d34'),
       (91, 'studienkolleg', 'preparatory-college', 'STK', 'Studienkolleg', 'Preparatory College', '0fsp'),
       (92, 'studienvorbereitungsprogramm', 'study-preparation-program', 'SVP', 'Studienvorbereitungsprogramm (PS)', 'Study Preparation Program', '0fsp'),
       (93, 'softwaretechnologie', 'software-technology', 'SWT', 'Softwaretechnologie', 'Software Technology', '0e16'),
       (94, 'technische-gebaeudeausruestung', 'technical-building-equipment', 'TGA', 'Technische Gebäudeausrüstung', 'Technical Building Equipment', '0787'),
       (95, 'technische-informatik', 'technical-informatics', 'TI', 'Technische Informatik', 'Technical Informatics', '0a72'),
       (96, 'technische-redaktion-multimediale-dokumentation', 'technical-writing-multimedia-documentation', 'TMD', 'Technische Redaktion und multimediale Dokumentation', 'Technical Writing and Multimedia Documentation', '0906'),
       (97, 'technischer-vertrieb', 'technical-sales', 'TV', 'Technischer Vertrieb', 'Technical Sales', '0c74'),
       (98, 'unternehmensfuehrung', 'corporate-governance', 'UF', 'Unternehmensführung', 'Corporate Governance', '0894'),
       (99, 'umwelt-hygiene-sicherheitsingenieurwesen', 'Environmental, hygiene-safety-engineering', 'UHS', 'Umwelt-, Hygiene- und Sicherheitsingenieurwesen', 'Environmental, Hygiene and Safety Engineering', '0a73'),
       (100, 'unternehmenssteuerung', 'corporate-management', 'US', 'Unternehmenssteuerung', 'Corporate Management', '0d76'),
       (101, 'vakuumingenieurwesen', 'vacuum-engineering', 'VI', 'Vakuumingenieurwesen', 'Vacuum Engineering', '0c69'),
       (102, 'betriebswirtschaft', 'business-administration', 'W', 'Betriebswirtschaft', 'Business Administration', '0021'),
       (103, 'betriebswirtschaft-losverfahren', 'business-administration-lottery', 'WL', 'Betriebswirtschaft Losverfahren', 'Business Administration Lottery', '0021'),
       (104, 'wirtschaftsingenieurwesen', 'business-administration-engineering', 'WI', 'Wirtschaftsingenieurwesen', 'Business Administration and Engineering', '0370'),
