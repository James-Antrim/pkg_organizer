...
VALUES (1, 'allgemeine-elektrotechnik', 'general-electrical-engineering', 'AET', 'Allgemeine Elektrotechnik', 'General Electrical Engineering'),
       ...
       (8, 'formgebung', 'design', 'FG', 'Formgebung', 'Design'),
       (9, 'hygiene-design', 'hygiene-design', 'HD', 'Hygiene Design', 'Hygiene Design'),
       (10, 'it-security', 'it-security', 'ITS', 'IT-Security', 'IT-Security'),
       (11, 'ingenieurwissenschaft', 'engineering', 'IWI', 'Ingenieurwissenschaft', 'Engineering'),
       (12, 'kaelte-klimatechnik', 'cold-climate-technology', 'KK', 'Kälte- und Klimatechnik', 'Cold and Climate Technology'),
       (13, 'krankenversicherungsmanagement', 'health-insurance-management', 'KM', 'Krankenversicherungsmanagement', 'Health Insurance Management'),
       (14, 'logistikmanagement', 'logistics-management', 'LM', 'Logistikmanagement', 'Logistics Management'),
       (15, 'medical-data-science', 'medical-data-science', 'MDS', 'Medical Data Science', 'Medical Data Science'),
       (16, 'mittelstandsmanagement', 'sme-management', 'MM', 'Mittelstandsmanagement', 'SME Management'),
       (17, 'management-marketing', 'management-marketing', 'MMA', 'Management und Marketing', 'Management and Marketing'),
       (18, 'maschinenbau', 'mechanical-engineering', 'MSB', 'Maschinenbau', 'Mechanical Engineering'),
       (19, 'metalltechnik', 'metal-technology', 'MT', 'Metalltechnik', 'Metal Technology'),
       (20, 'regulatory-affairs-management', 'regulatory-affairs-management', 'RAM', 'Regulatory Affairs Management', 'Regulatory Affairs Management'),
       (21, 'softwareentwicklung', 'software-development', 'SE', 'Softwareentwicklung', 'Software Development'),
       (22, 'steuerung-geschaeftsprozessen', 'controlling-business-processes', 'SG', 'Steuerung von Geschäftsprozessen', 'Controlling Business Processes'),
       (23, 'technische-gebaeudeausruestung', 'building-services-engineering', 'TGA', 'Technische Gebäudeausrüstung', 'Building Services Engineering'),
       (24, 'technische-informatik', 'technical-informatics', 'TI', 'Technische Informatik', 'Technical Informatics'),
       (25, 'technische-prozesse', 'technical-processes', 'TP', 'Technische Prozesse', 'Technical Processes'),
       (26, 'vertrieb', 'sales', 'V', 'Vertrieb', 'Sales'),
       (27, 'veranstaltungstechnik', 'event-technology', 'VTK', 'Veranstaltungstechnik', 'Event Technology'),
       (28, 'verkehr-wasser-umwelt', 'traffic-water-environment', 'VWU', 'Verkehr - Wasser - Umwelt', 'Traffic - Water - Environment'),
       (29, 'wirtschaftsinformatik', 'business-informatics', 'WIN', 'Wirtschaftsinformatik', 'Business Informatics');
