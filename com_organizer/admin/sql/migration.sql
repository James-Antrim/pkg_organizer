...
UPDATE `v7ocf_organizer_degrees` SET `id` = 25, `statisticCode` = 90 WHERE `id` = 5;
UPDATE `v7ocf_organizer_degrees` SET `id` = 24, `statisticCode` = 90, `name` = 'Master of Higher Education' WHERE `id` = 8;
UPDATE `v7ocf_organizer_degrees` SET `id` = 23, `statisticCode` = 90 WHERE `id` = 4;
UPDATE `v7ocf_organizer_degrees` SET `id` = 22, `statisticCode` = 90, `alias`         = 'mbae' WHERE `id` = 7;
UPDATE `v7ocf_organizer_degrees` SET `id` = 20, `statisticCode` = 90 WHERE `id` = 6;
UPDATE `v7ocf_organizer_degrees` SET `id` = 7, `statisticCode` = 84 WHERE `id` = 2;
UPDATE `v7ocf_organizer_degrees` SET `id` = 6, `statisticCode` = 84 WHERE `id` = 1;
UPDATE `v7ocf_organizer_degrees` SET `id` = 5, `statisticCode` = 84 WHERE `id` = 9;
UPDATE `v7ocf_organizer_degrees` SET `id` = 2, `statisticCode` = 84 WHERE `id` = 3;
...
ALTER TABLE `v7ocf_organizer_degrees` MODIFY COLUMN `statisticCode` TINYINT(2) UNSIGNED NOT NULL;
