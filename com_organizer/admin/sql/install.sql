...
(
    ...
    `statisticCode` VARCHAR(10)                  DEFAULT NULL,
    PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `#__organizer_minors`
(
    `id`              INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
    `alias_de`        VARCHAR(255)     NOT NULL,
    `alias_en`        VARCHAR(255)     NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__organizer_program_forms`
(
    `id`            INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
    `alias_de`      VARCHAR(255)     NOT NULL,
    `alias_en`      VARCHAR(255)     NOT NULL,
...
VALUES (11, '011', 'Wohnflächen im Freien', 'Outdoor Residential Areas', 1, 0),
       ...
       (414, '414', 'Lagerräume mit betriebsspezifischen Einbauten', 'Storage Rooms w/ Operational Fixtures', 1, 4),
...
(
    ...
    `evaluated`                   TINYINT(1) UNSIGNED NOT NULL DEFAULT 1,
...
VALUES (110, '0110', 'Wohnfläche im Freien', 'Outdoor Residential Area', 11, 0, 0),
       ...
       (1120, '1120', 'Wohnküche', 'Kitchen, Residential', 112, 2, 3),
       ...
       (5840, '5840', 'Besucherfläche', 'Visitor Area', 584, 2, 3),
...
ALTER TABLE `#__organizer_programs`
    ...
    ADD CONSTRAINT `program_campusID_fk` FOREIGN KEY (`campusID`) REFERENCES `#__organizer_campuses` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
    ...
    ADD CONSTRAINT `program_degreeID_fk` FOREIGN KEY (`degreeID`) REFERENCES `#__organizer_degrees` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    ...
    ADD CONSTRAINT `program_formID_fk` FOREIGN KEY (`formsID`) REFERENCES `#__organizer_program_forms` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
