...
class QueryMySQLi extends JDatabaseQueryMysqli
{
    ...
    /**
     * Wraps the the clear function in its own function to minimize the display of "<statement> or DELIMITER expected"
     * errors.
     * @inheritDoc
     * @return  QueryMySQLi  returns this object to allow chaining
     */
     ...
     *
     * @param string         $table  the unique part of an organizer table name, or a complete table name, optionally
     *                               with alias
